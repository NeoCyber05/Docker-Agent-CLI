"""remove_container tool Ã¢â‚¬â€ stop and remove physical Docker containers."""
...
class _RemoveContainerTool:
    ...
    description = (
        "Remove specific orphan Docker containers by exact name or ID Ã¢â‚¬â€ for leftovers "
