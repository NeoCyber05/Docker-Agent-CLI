"""Parity tests for get_health â€” mirrors getHealth.test.ts and computeStats.test.ts."""
...
from docker_mcp_server.services.docker.types import ContainerStats, ContainerSummary
from docker_mcp_server.tools.base import ToolContext
from docker_mcp_server.tools.get_health import compute_stats, get_health
...
class _SingleContainerEngine:
    ...
    async def inspect(self, _container_id: str):
        from docker_mcp_server.services.docker.types import ContainerInspect
