...
from src.slash_commands import get_slash_command_suggestions
from src.slash_router import SlashCommandDef
from src.ui.interaction_state import InteractionPhase

PHASE_HINTS: dict[InteractionPhase, str] = {
    "running": "(Processing… Ctrl+C to cancel)",
    "cancelling": "(Processing… Ctrl+C to cancel)",
