...
def dispatch_secrets_list(stack_name: str, _ctx: SlashDispatchContext) -> DirectSlashResult:
    return {"ok": True, "text": f"Use the agent prompt `List secret keys for stack {stack_name}`."}
