...
from infra_agent.components.slash_highlighter import SlashCommandHighlighter
from infra_agent.slash.commands import get_slash_command_suggestions
from infra_agent.slash.router import SlashCommandDef
from infra_agent.ui.interaction_state import InteractionPhase
