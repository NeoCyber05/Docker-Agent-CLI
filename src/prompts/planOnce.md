...
The user wants to DEPLOY a stack. Your job is to call the `plan_stack` tool exactly once with a complete service specification. Do not reply with prose alone — the user expects a structured plan.
