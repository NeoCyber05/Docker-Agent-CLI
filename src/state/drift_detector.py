...
from src.services.docker.types import ContainerInspect, EngineClient
from src.state.env_file import merge_env, read_env_file
from src.state.secret_redactor import redact_env
...
def _parse_actual_ports(
    network_ports: dict[str, list[dict[str, str]] | None]
) -> list[str]:
    out: list[str] = []
